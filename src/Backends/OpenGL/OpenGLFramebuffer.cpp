...
void OpenGLFramebuffer::Resize(unsigned int width, unsigned int height)
{
    ...
    {
        WARN("Attempted to rezize framebuffer to {0}, {1}", width, height);
        return;
    }
...
int OpenGLFramebuffer::ReadPixel(unsigned int index, int x, int y) const
{
...
void OpenGLFramebuffer::ClearAttachment(unsigned int index, int value)
{
    ASSERT(index < m_ColorAttachments.size());
